...
class EntProfilePopulateScreen extends Component {
  ...
  locationToString = () => {
    ...
    return profileData.locations? `${profileData.locations[0]?.country?.name},${profileData.locations[0].city?.name},${profileData.locations[0]?.region?.name}`:"";
  };
